...
session_start();
if($_POST){
  if(($_POST['usuario']=="adminropa")&&($_POST['contrasenia']=="sistema")){
    $_SESSION['usuario']="ok";
    $_SESSION['nombreUsuario']="Adminropa";
...
<br/> <br/> <br/>
            ...
            <label >Usuario</label>
            <input type="text" class="form-control" name="usuario" placeholder="Escribe tu usuario y contraseña">
            </div>
